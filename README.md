...
[![Get API Key](https://img.shields.io/badge/Get_API_Key-proxytracer.com-red?style=for-the-badge)](https://proxytracer.com/dashboard)
...
| **Velocity** proxy network | `proxytracer-velocity-1.3.0.jar` | Proxy server `plugins/` (Do not install on Paper) |
| **BungeeCord / Waterfall** network | `proxytracer-bungee-1.3.0.jar` | Proxy server `plugins/` (Do not install on Paper) |
...
* **API Access:** A free or paid API key registered at [ProxyTracer.com](https://proxytracer.com/dashboard).
